...
test('MajorityResult component', () => {
  ...
  // @ts-ignore
  const wrapper = mount(MajorityResult, {
    global,
    props: {
      abstainCount: 3,
      proposals: [1, 2],
...
test('RepeatedIRVResult component', async () => {
  ...
  // @ts-ignore
  const wrapper = mount(RepeatedIRVResult, {
    global,
    props: {
      abstainCount: 3,
      proposals: [1, 2, 3],
...
test('RepeatedSchulzeResult component', async () => {
  ...
  // @ts-ignore
  const wrapper = mount(RepeatedSchulzeResult, {
    global,
    props: {
      abstainCount: 3,
      proposals: [1, 2, 3],
...
test('SchulzeResult component', async () => {
  ...
  // @ts-ignore
  const wrapper = mount(SchulzeResult, {
    global,
    props: {
      abstainCount: 3,
      proposals: [1, 2, 3],
...
test('SimpleResult component', () => {
  ...
  // This does not test management, only number display
  // @ts-ignore
  const wrapper = mount(SimpleResult, {
    global,
    props: {
      abstainCount: 3,
      proposals: [1, 2, 3],
